...
# set up IO
input_dir = file.path(base_dir, "replicate_integration")
output_dir = "~/git/CF-MS-analysis/data/analysis/replicate_integration"
...
# save
output_dir = "data/analysis/replicate_integration"
if (!dir.exists(output_dir))
  dir.create(output_dir)
