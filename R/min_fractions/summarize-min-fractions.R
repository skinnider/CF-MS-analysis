# Collate all protein complex and GO AUCs from the min. fractions experiment
# into a single file.
...
# set up IO
input_dir = file.path(base_dir, "min_fractions")
output_dir = "~/git/CF-MS-analysis/data/analysis/min_fractions"
