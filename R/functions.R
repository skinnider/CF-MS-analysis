...
metrics = c(
  'pearson', 'spearman', 'kendall', 'bicor', 'weighted_rank', 'zi_kendall',
  'euclidean', 'manhattan', 'canberra', 'cosine',
  'jaccard', 'hamming', 'dice', 'phi_s', 'rho_p', 'MI', 'binomial',
  'bayes_cor', 'bray_curtis', 'wccor', 'distance_cor', 'profile_cor',
  'GENIE3', 'treeClust'
)

# adapted from https://github.com/skinnider/dismay
